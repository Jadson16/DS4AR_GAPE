---
title: "Introdução ao R e mundo *tidyverse*"
...
-   Ciência de Dados (*Data Science*); \pause

    \bigskip

-   Conjunto de técnicas de coleta, tratamento, análise e apresetação de dados; \pause

    \bigskip

-   Sistematização de dados em busca informações úteis. \pause
