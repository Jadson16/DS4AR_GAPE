...
- Apresentar a relação da sistematização de um projeto de Data Science (DS) e os modelos canônicos da pesquisa acadêmica, sobretudo, em de pesquisas que utiliza aboragem empíricas.

# Pesquisa Teórica e Pesquisa Teórica-Empírica


## Passos

# Estrutura de um Artigo Empírico

# Reprodutibilidade da Pesquisa Ciêntifica

# DS como prática acadêmica
